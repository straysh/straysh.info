...
class MenuBuilder implements Countable
{
     ...
     * @var string
     */
    protected $presenter = 'App\Http\Helpers\Menus\Presenters\Bootstrap\NavbarPresenter';
     ...
     * @param  string $key
     * @param  string $value
     * @return \App\Http\Helpers\Menus\MenuItem
     */
     ...
     *
     * @return \App\Http\Helpers\Menus\Presenters\PresenterInterface
     */
