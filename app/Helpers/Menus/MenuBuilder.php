<?php namespace App\Helpers\Menus;
...
class MenuBuilder implements Countable
{
     ...
     * @var string
     */
    protected $presenter = 'App\Helpers\Menus\Presenters\Bootstrap\NavbarPresenter';
     ...
     * @param  string $key
     * @param  string $value
     * @return \App\Helpers\Menus\MenuItem
     */
     ...
     *
     * @return \App\Helpers\Menus\Presenters\PresenterInterface
     */
