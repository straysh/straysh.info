@if(isOnPages())
	@if(isset($model))
	{!! Form::model($model, ['method' => 'PUT', 'files' => false, 'route' => ['pages.update', $model->id]]) !!}
	@else
	{!! Form::open(['files' => false, 'route' => 'pages.store']) !!}
	@endif
@else
	@if(isset($model))
	{!! Form::model($model, ['method' => 'PUT', 'files' => false, 'route' => ['articles.update', $model->id]]) !!}
	@else
...
@endif
	...
	@endif
	{!! Form::hidden('author', 'straysh') !!}
	<div class="form-group">
		{!! Form::label('body', 'Body:') !!}
		{!! Form::textarea('body', null, ['class' => 'form-control', 'id' => 'ckeditor', 'rows'=>'50']) !!}
